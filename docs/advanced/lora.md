...
| Bridge | Qwen3 4B | Dense | [Single-LoRA recipe](https://github.com/radixark/miles/blob/main/examples/lora/run-qwen3-4B-megatron-lora.sh), [multi-LoRA recipe](https://github.com/radixark/miles/tree/main/examples/multi_lora), [multi-LoRA CUDA/ROCm E2E](https://github.com/radixark/miles/blob/main/tests/e2e/lora/test_multi_lora_qwen3_4B.py) | Used by the current multi-adapter example. |
